...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 11 09:47:20 2020
...
"""
def main_EndoCV2020(MINOVERLAP, type, resultsfolder, gtfolder, predictfolder ):
...
#    pred_classes = list(pred_counter_per_class.keys())
    ...
    """
#    resultFile="results_"+str(MINOVERLAP)+'_'+type+'.txt'
#    
#    with open(os.path.join(results_files_path + resultFile), 'a') as results_file:
